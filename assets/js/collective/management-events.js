...
const thisDay = dayjs && dayjs().format('DD');
const plus2Day = dayjs && dayjs().add(2, 'day').format('DD');
const thisMonthNumber = dayjs && dayjs().format('MM');
const thisMonthName = dayjs && dayjs().format('MMM');
const upcomingMonthNumber =
  dayjs && dayjs().add(1, 'month').format('MM');
const upcomingMonthName = dayjs && dayjs().format('MMM');

const thisYear = dayjs && dayjs().format('YYYY');
