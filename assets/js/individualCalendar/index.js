...
import handleInterviewFormSubmit from "./handleInterviewFormSubmit";

/*-----------------------------------------------
|   Calendar
-----------------------------------------------*/
const appInterviewCalendarInit = () => {
  const Selectors = {
    ACTIVE: '.active',
  ...
  if (appCalendar) {
    const calendar = renderCalendar(appCalendar, {
      ...
      eventClick: (info) => {
        ...
        $(".InterviewRemove").on("submit", handleRemoveInterviewFormSubmit)
        function handleRemoveInterviewFormSubmit(e) {
          e.preventDefault()
...
export default appInterviewCalendarInit;
